...
revision, and Invoice-specific read projections from A16.
...
The A08 evening pull protocol: Invoice-only work discovery, immutable M21
manifests, node-scoped M22 issuance, exact-byte package delivery, M23 receipt
acceptance, unchanged M29 transport, reconciliation, and explicit M28 conflict
outcomes.
...
Manifest canonicalization, package assembly, issuance locking, repeat pulls,
receipt matching, unknown-outcome recovery, and incompatibility/conflict
classification.
