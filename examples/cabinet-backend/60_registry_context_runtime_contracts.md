...
- RegistryContextService.__init__(self, repository: RegistryContextRepository) -> None
...
- RegistryContextRepository.replace_work_objects(self, work_objects: tuple[WorkObject, ...]) -> None
