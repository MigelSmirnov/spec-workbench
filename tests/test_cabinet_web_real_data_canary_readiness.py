...
def test_interop_is_ready_but_real_canary_is_blocked_only_by_missing_real_candidate():
    readiness = load()
...
def test_test_or_synthetic_data_cannot_be_relabelled_as_real_data_canary():
