...
RULES = {
    ...
    for item in (
        ...
        _rule("model_shape_unresolved", "defining", "state1:models"),
        _rule("closed_value_type_unresolved", "defining", "state1:models"),
        ...
        _rule("data_domain_mismatch", "defining", "pre_contract:data_closure"),
        _rule("data_provider_missing", "defining", "deterministic_data_provider"),
        _rule("data_form_invalid", "defining", "pre_contract:data_closure"),
        _rule("data_owner_unresolved", "defining", "pre_contract:data_closure"),
        ...
        _rule("runtime_settings_wiring_missing", "convergence", "composition:runtime_settings"),
        _rule("data_reference_overscoped", "convergence", "downstream_expression"),
        ...
        _rule("producer_unresolved", "convergence", "state6:contracts"),
...
FINDING_MAP = {
    ...
    "data_domain_mismatch": "data_domain_mismatch",
    "data_provider_missing": "data_provider_missing",
    "runtime_settings_wiring_missing": "runtime_settings_wiring_missing",
    "data_form_invalid": "data_form_invalid",
    "data_reference_overscoped": "data_reference_overscoped",
    "data_owner_unresolved": "data_owner_unresolved",
